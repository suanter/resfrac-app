...
var constants_1 = require("../src/app/config/constants");
...
// const clientId =
//   "522833765011-19qdddti37lrtcgn350j3a0bvijki6av.apps.googleusercontent.com";
...
var AuthFlow = /** @class */ (function () {
    function AuthFlow() {
        ...
        this.notifier.setAuthorizationListener(function (request, response, error) {
            ...
            if (response) {
                console.log("Response from authoriztion Listener");
                ...
                _this.makeRefreshTokenRequest(response.code, codeVerifier)
                    ...
                    instance.get('/oauth2/v2/userinfo')
                        ...
                        userData['logged'] = _this.loggedIn();
                        _this.user_data = userData;
                        _this.authStateEmitter.emit(AuthStateEmitter.ON_TOKEN_RESPONSE, userData);
                        log("All Done.");
                    });
                });
            }
    ...
    AuthFlow.prototype.getUserData = function () {
        if (this.user_data)
            return this.user_data;
    };
    AuthFlow.prototype.fetchServiceConfiguration = function () {
        var _this = this;
        return authorization_service_configuration_1.AuthorizationServiceConfiguration.fetchFromIssuer(constants_1.Constants.API_OPEN_ID_CONNECT_URL, requestor).then(function (response) {
